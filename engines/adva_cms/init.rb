...
register_javascript_expansion \
  :common  => %w( adva_cms/jquery/jquery adva_cms/jquery/jquery-lowpro adva_cms/jquery/jquery-ui 
                  ...
                  adva_cms/jquery.droppy adva_cms/fancybox/jquery.fancybox application ),
  :login   => %w(),
...
register_stylesheet_expansion \
  :default => %w( adva_cms/default adva_cms/common adva_cms/forms adva_cms/droppy adva_cms/fancybox/jquery.fancybox ),
